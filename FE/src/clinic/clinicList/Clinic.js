...
class Clinic extends Component {
    ...
    handleChangeEditorEditPost = (editorState) => {
                        ...
                        <div className="main-clinic">
                            ...
                            <div className="commnet-modal">
                                ...
                                >
                                    ...
                                    <hr className="line-line-post"></hr>
                                    <BraftEditor contentStyle={{ height: 400, boxShadow: 'inset 0 1px 3px rgba(0,0,0,.1)' }} language="en" placeholder="Nhập thông tin phòng khám ...." value={this.state.editorStateContentPost} onChange={this.handleChangeEditorEditPost} />
                                </Modal>
                            </div>
                            <div className="commnet-modal-">
                                <Modal
